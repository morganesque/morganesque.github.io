...
(function(a){a.fn.slabText=function(b){var c={fontRatio:0.78,forceNewCharCount:true,wrapAmpersand:true,headerBreakpoint:null,viewportBreakpoint:null,noResizeEvent:false,resizeThrottleTime:300,maxFontSize:999,postTweak:true,precision:3};a("body").addClass("slabtexted");return this.each(function(){if(b){a.extend(c,b)}var i=a(this),p=a("span.slabtext",i).length,n=p?[]:String(a.trim(i.text())).replace(/\s{2,}/g," ").split(" "),d=null,l=null,q=c.fontRatio,h=c.forceNewCharCount,f=c.headerBreakpoint,o=c.viewportBreakpoint,j=c.postTweak,t=c.precision,s=c.resizeThrottleTime,k=null,r=a(window).width(),m=i.find("a:first").attr("href")||i.attr("href"),e=m?i.find("a:first").attr("title"):"";var u=function(){var w=jQuery('<div style="display:none;font-size:1em;margin:0;padding:0;height:auto;line-height:1;border:0;">&nbsp;</div>').appendTo(i),v=w.height();w.remove();return v};var g=function g(){var E=i.width(),A;i.removeClass("slabtextdone slabtextinactive");if(o&&o>r||f&&f>E){i.addClass("slabtextinactive");return}A=u();if(!p&&(h||A!=d)){d=A;var F=Math.min(60,Math.floor(E/(d*q))),y=0,D=[],w=0,x="",B="",C="",v,z;if(F!=l){l=F;while(y<n.length){B="";while(B.length<l){x=B;B+=n[y]+" ";if(++y>=n.length){break}}v=l-x.length;z=B.length-l;if((v<z)&&(x.length>2)){C=x;y--}else{C=B}C=a("<div/>").text(C).html();if(c.wrapAmpersand){C=C.replace(/&amp;/g,'<span class="amp">&amp;</span>')}C=a.trim(C);D.push('<span class="slabtext">'+C+"</span>")}i.html(D.join(" "));if(m){i.wrapInner('<a href="'+m+'" '+(e?'title="'+e+'" ':"")+"/>")}}}else{d=A}a("span.slabtext",i).each(function(){var G=a(this),K=G.text(),H=K.split(" ").length>1,L,I,J;if(j){G.css({"word-spacing":0,"letter-spacing":0})}I=E/G.width();J=parseFloat(this.style.fontSize)||d;G.css("font-size",Math.min((J*I).toFixed(t),c.maxFontSize)+"px");L=!!j?E-G.width():false;if(L){G.css((H?"word":"letter")+"-spacing",(L/(H?K.split(" ").length-1:K.length)).toFixed(t)+"px")}});i.addClass("slabtextdone")};g();if(!c.noResizeEvent){a(window).resize(function(){if(a(window).width()==r){return}r=a(window).width();clearTimeout(k);k=setTimeout(g,s)})}})}})(jQuery);
/*! page.js -  This is the main code for the website */
$(document).ready(function(){if($(window).width()>480){$(".single .tags").prependTo(".body")}var a=function(){var b=$(this).width();var c=Math.floor(b/16);$(".debug .resize").html(b+" <br /> 16 :"+c+"em")};$(window).on("resize",a);a();$(".poem a").each(function(c){var b="link-"+(c+1);$(this).addClass(b)})});function doSlabText(){console.log("SlabText: doing");$(".job").slabText();$("#jobTitle").css({opacity:1})}$(window).load(function(){doSlabText();(function(){var d=[];var f=0;function e(){var g="/inc/page-"+d[f]+".php";$("<div>").load(g,function(){$("body").append($(this).html());f++;if(d[f]!==undefined){e()}})}if(d[f]!==undefined){e()}})();$(".portfolio .project").each(function(){var f=$(this).css("background-image");var d=f.substr(4,f.length-5);var e=d.replace(".png",".jpg");$(this).data("alt-back",e).hover(function(){$(this).css("background-image","url("+e+")")},function(){$(this).css("background-image",f)})});var b=$(window).width();if(b>480){$(".march-map img").attr("src","/img/march.jpg")}var c=$("#vid-respon").html();console.log(c);console.log($(".vid-respon"));$(".vid-respon").html(c);var a=$("#vid-magic").html();$(".vid-magic").html(a)});(function(){var c=1000;var b={array_filter:function(d,f){var g={};for(var e in d){if(f(d[e])){g[e]=d[e]}}return g},filemtime:function(d){var e=this.get_headers(d,1);return(e&&e["Last-Modified"]&&Date.parse(e["Last-Modified"])/1000)||false},get_headers:function(d,n){var m=window.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):new XMLHttpRequest();if(!m){throw new Error("XMLHttpRequest not supported.")}var k,e,g,l,h=0;try{m.open("HEAD",d,false);m.send(null);if(m.readyState<3){return false}k=m.getAllResponseHeaders();k=k.split("\n");k=this.array_filter(k,function(i){return i.toString().substring(1)!==""});e=n?{}:[];for(l in k){if(n){g=k[l].toString().split(":");e[g.splice(0,1)]=g.join(":").substring(1)}else{e[h++]=k[l]}}return e}catch(f){return false}}};var a=function(){this.reloadFile=function(o){for(var n=0,m=o.length;n<m;n++){var s=o[n],r=b.filemtime(this.getRandom(s.href));if(s.last){if(s.last!=r){var p=new Date();var q=p.to24HourString();console.log("updated: "+q+" "+s.href);s.elem.setAttribute("href",this.getRandom(s.href))}}s.last=r}setTimeout(function(){this.reloadFile(o)},c)};this.getHref=function(l){return l.getAttribute("href").split("?")[0]};this.getRandom=function(l){return l+"?x="+Math.random()};var k=document.getElementsByTagName("link"),h=[];for(var f=0,e=k.length;f<e;f++){var j=k[f],d=j.rel;var i=j.getAttribute("live");if(i=="true"&&(typeof d!="string"||d.length===0||d=="stylesheet")){var g=this.getHref(j);console.log("CSSRefresh: "+g);h.push({elem:j,href:g,last:false})}}this.reloadFile(h)};a()})();